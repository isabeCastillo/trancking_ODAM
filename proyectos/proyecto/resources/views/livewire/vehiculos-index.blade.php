...
<div class="user-management-container">
    ...
    <h2 class="title-header">Gestión de Vehículos</h2>
    ...
    <div class="card-container">
        ...
        <div class="filter-actions">
            <div class="filter-controls">
                <input type="text" wire:model.live="buscar" placeholder="Buscar vehículo...">
            </div>

            <a href="{{ route('vehiculos.create') }}" class="create-button">
                + Nuevo Vehículo
            </a>
        </div>
        ...
        <table class="data-table">
            ...
            <tbody>
                @forelse($vehiculos as $v)
                    <tr>
                        ...
                        <td data-label="Motorista">
                            {{ $v->motorista?->name ?? 'Sin motorista' }}
                        </td>

                        <td data-label="Acciones">
                            <a href="{{ route('vehiculos.edit', $v->id) }}" class="action-link">
                                Editar
                            </a>
                ...
                @empty
                    <tr class="empty-row">
                        <td colspan="9">No se encontraron vehículos.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
